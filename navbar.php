        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
                    ...
                    <a href="http://ec2-54-78-185-241.eu-west-1.compute.amazonaws.com/team7/search.php">Search</a></li>
            ...
            ?>
                ...
                ?>
                    ...
                    <ul class="nav navbar-nav navbar-right extraPadding">
                        <li>
                            <p>
                                <?php     
                        ...
                        <li><a style="padding: 0px; margin-left: 26px;" href="" id="logout">Logout</a></li>
                    </ul>
