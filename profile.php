    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="profileBanner">
                <div class="profileImage"><img src="http://bromleydivingclub.com/wp-content/uploads/2013/07/placeholder.png" class="img-circle img-responsive img-center" height="200px" width="200px"></div>
            </div>
            <!-- /.row -->
            ...
            <div class="row">
                <div id="leftBox"><div class="content"><h3>Details</h4><b>Name: </b><?php echo($firstName . ' ' . $lastName); ?><br><b>Email:</b> <?php echo($email); ?><br><b>Age:</b> 20</br><b></b></div></div>
